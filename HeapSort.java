 ...
 */
 ...
 public class HeapSort {
    ...
    private static void heapify(int[] arr, int i, int n) {
      ...
      //Проверка чтоб дочепние не стали больше чем родители
      ...
      //Если, дочерний оказался больше родителя, то делаем обмен,
      //дочернего с родителем. Если самый большой элемент не корень
      if (i != largest){
        int temp = arr[i];
        arr[i] = arr[largest];
        arr[largest] = temp;
